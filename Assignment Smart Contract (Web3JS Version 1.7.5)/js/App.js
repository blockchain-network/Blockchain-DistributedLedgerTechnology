...
DigitalPortfolioContract.prototype.init = function(cb) {
	...
	// Create the contract interface using the ABI & specific address provided in the configuration.
...
DigitalPortfolioContract.prototype.bindButtons = function() {
    ...
    $(document).on("change", "#RegisterEducationwalletAddress", function(){
        ...
        if (that.web3.utils.isAddress(input) == true) {
            result.innerHTML = "";
        } else {
...
DigitalPortfolioContract.prototype.getEduCount = function (cb) {
    this.instance.methods.eduCount().call(function (error, eduCount) {
        cb(error, eduCount);
    });
};
...
DigitalPortfolioContract.prototype.getAllEducation = function (eduCount, cb) {
    this.instance.methods.getEducation(eduCount).call(function (error, education) {
        cb(error, education);
    });
};
...
DigitalPortfolioContract.prototype.loadEducationRegistration = function () {
	...
	var nextEduCount = Number(eduCount) + 1;
...
DigitalPortfolioContract.prototype.registerNewEducation = function() {
    ...
    this.instance.methods.registerNewEducation(institutionName, course, startDate, endDate, grade, status, walletAddress).send(
        //gas required to execute the transaction
        { from: account, gas: 1000000, gasPrice: 1000000000, gasLimit: 1000000 }).on('receipt', function(receipt){
            if(error){
                console.log(error);
            }
            else{
...
DigitalPortfolioContract.prototype.UpdateEducationRegistration = function () {
    ...
    that.instance.methods.getEducation(UpdateEducationNo).call(function(error, education){
        var institutionName = education[0];
        var course = education[1];
        var startdate = education[2];
        var enddate = education[3];
...
DigitalPortfolioContract.prototype.UpdateEducation = function() {
    ...
    this.instance.methods.updateEducation(UpdateEducationNo, institutionName, course, startDate, endDate, grade, status, walletAddress).send(
        //gas required to execute the transaction
        { from: account, gas: 1000000, gasPrice: 1000000000, gasLimit: 1000000 }).on('receipt', function(receipt){
            if(error){
                console.log(error);
...
DigitalPortfolioContract.prototype.getCertCount = function (cb) {
    this.instance.methods.certCount().call(function (error, certCount) {
        cb(error, certCount);
    });
};
...
DigitalPortfolioContract.prototype.getAllCertificates = function (certCount, cb) {
    this.instance.methods.getCertificate(certCount).call(function (error, certificate) {
...
DigitalPortfolioContract.prototype.loadCertificate = function () {
    ...
    var nextCertCount = Number(certCount) + 1;
...
DigitalPortfolioContract.prototype.registerNewCertificate = function() {
    ...
    this.instance.methods.registerNewCertificate(certTitle, issuer, dateObtained, walletAddress).send(
        //gas required to execute the transaction
        { from: account, gas: 1000000, gasPrice: 1000000000, gasLimit: 1000000 }).on('receipt', function(receipt){
            if(error){
                console.log(error);
...
DigitalPortfolioContract.prototype.getworkExpCount = function (cb) {
    this.instance.methods.workCount().call(function (error, workCount) {
        cb(error, workCount);
    });
};
...
DigitalPortfolioContract.prototype.getAllWorkExperience = function (workCount, cb) {
    this.instance.methods.getWorkExperience(workCount).call(function (error, workExperience) {
...
DigitalPortfolioContract.prototype.loadWorkExperience = function () {
    ...
    var nextWorkCount = Number(workCount) + 1;
...
DigitalPortfolioContract.prototype.registerNewWorkExperience = function() {
    ...
    this.instance.methods.registerNewWorkExperience(companyName, jobTitle, startDate, endDate, skills, jobDescription, walletAddress).send(
        //gas required to execute the transaction
        { from: account, gas: 1000000, gasPrice: 1000000000, gasLimit: 1000000 }).on('receipt', function(receipt){
            if(error){
                console.log(error);
...
DigitalPortfolioContract.prototype.UpdateWorkExperienceRegistration = function () {
    ...
    that.instance.methods.getWorkExperience(UpdateWorkExpNo).call(function(error, workExperience){
        var companyName = workExperience[0];
        var jobTitle = workExperience[1];
        var startDate = workExperience[2];
        var endDate = workExperience[3];
...
DigitalPortfolioContract.prototype.UpdateWorkExperience = function() {
    ...
    this.instance.methods.updateWorkExperience(UpdateWorkExpNo, companyName, jobTitle, startDate, endDate, skills, jobDescription, walletAddress).send(
        //gas required to execute the transaction
        { from: account, gas: 1000000, gasPrice: 1000000000, gasLimit: 1000000 }).on('receipt', function(receipt){
            if(error){
                console.log(error);
